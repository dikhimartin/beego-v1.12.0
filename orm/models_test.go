...
type Post struct {
	...
	Updated time.Time `orm:"auto_now"`
	Tags    []*Tag    `orm:"rel(m2m);rel_through(github.com/dikhimartin/beego-v1.12.0/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/dikhimartin/beego-v1.12.0/orm.GroupPermissions)"`
}
...
var (
	...
	go get -u github.com/dikhimartin/beego-v1.12.0/orm
	...
	go test -v github.com/dikhimartin/beego-v1.12.0/orm
